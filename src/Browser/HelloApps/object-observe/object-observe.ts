...
if(!Object.observe){
  (function(extend, global){
    ...
    var _listeners = [], _updates = [], _updater = 0, properties = [], values = [];
      var self = this;
...
// Allows an application to emulate the Google Object.observe proposal
// See http://wiki.ecmascript.org/doku.php?id=harmony:observe

module AngularRemote {

    // Tests if there is a native implementation of Object.observer
    export function HasNativeObserver() {
        if (Object.observe) {
...
//        (<any>Object.prototype).getNotifier = function () {
//            // TODO
//        };

//        (<any>Object.prototype).observe = function () {
//            // TODO
//        };

//        (<any>Object.prototype).deliverChangeRecords = function () {
//            // TODO
//        };
//    }

    // Represents an individual change to an Ecmascript object
    export class ChangeRecord {

        constructor (public type: string, public object: any, public name: string, public oldValue: any) {
            // TODO! Real implementation
            LogOutgoing(type + " " + JsonPatch.JsonPointer.Create(object,name).GetPath() + " value=" + object[name] + " (" + oldValue + ")" );
        }
    }   
}