    ...
    public static class HelpPage {
        ...
        static string ExpandMetadata(string line, HelpPageTemplate template) {
            if (line.Contains(HelpPageTemplate.Variables.DELIMITER)) {
                line = line.Replace(HelpPageTemplate.MetadataVariables.MetadataSum, template.Metadata.Length.ToString());
                line = line.Replace(HelpPageTemplate.MetadataVariables.AutoContentSum, template.AutoGenerated.Length.ToString());
                line = line.Replace(HelpPageTemplate.MetadataVariables.UserContentSum, template.UserContent.Length.ToString());
            }
            return line;
        }
