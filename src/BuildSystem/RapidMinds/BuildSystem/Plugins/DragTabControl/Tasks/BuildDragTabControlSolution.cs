...
{
    public class BuildDragTabControlSolution
    {
        #region Properties
        ...
        public BuildDragTabControlSolution(string executable, string solutionFile)
        {
        ...
        public void Execute()
        {
            ...
            Console.Error.WriteLine("------ Build started: Building DragTabControl solution ------");
            Console.ResetColor();
