...
START scdata.exe %1 %1 .db.output

:: Starting connection monitor on PERSONAL server.
START scipcmonitor.exe PERSONAL .db.output

:: Starting the specific database.
::START sccode.exe %1 --DatabaseDir=.db --OutputDir=.db.output --TempDir=.db.output --CompilerPath=MinGW\bin\x86_64-w64-mingw32-gcc.exe --AutoStartExePath=C:\sc\Level1\src\Samples\MySampleApp\bin\debug\mysampleapp.exe
...
START scnetworkgateway.exe PERSONAL scnetworkgateway.xml .db.output
