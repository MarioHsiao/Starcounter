...
public:
	 ...
	 */
	explicit scheduler_number_pool(const char* segment_name = 0,
	scheduler_number scheduler_num = no_scheduler_number);
	 ...
	 */
	bool insert(value_type item, owner_id id,
	 ...
	 */
	bool erase(value_type item, owner_id id,
	smp::spinlock::milliseconds timeout);
	 ...
	 */
	bool acquire(value_type* item, owner_id id,
	smp::spinlock::milliseconds timeout);
	 ...
	 */
	bool release(value_type item, owner_id id,
	smp::spinlock::milliseconds timeout);
