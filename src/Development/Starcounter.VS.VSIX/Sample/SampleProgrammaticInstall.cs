...
namespace Starcounter.VS11.Extension.Sample
{
    ...
    public static class Program
    {
        ...
        /// </summary>
        const string VisualStudioFolder = @"c:\Program Files (x86)\Microsoft Visual Studio 11.0\Common7\IDE";
        ...
        public static void Main(string[] args)
        {
            ...
            var version = VisualStudioVersion.VS11.ToVersionString();
        ...
        static void Install(string installer, string edition, string version)
        {
            ...
            // VSIXInstaller.exe /quiet /skuName:Pro /skuVersion:11.0 Starcounter.VS11.Extension.vsix
            //
            // Explanation:
            // Uninstall the extension described in the Starcounter.VS11.Extension.vsix file into Visual
            // Studio 11 Professional.
        ...
        {
            return version == VisualStudioVersion.VS2010 ? "10.0" : "11.0";
        }
    }
}
