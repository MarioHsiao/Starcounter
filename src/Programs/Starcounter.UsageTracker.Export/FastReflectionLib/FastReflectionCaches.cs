...
namespace FastReflectionLib
{
    internal static class FastReflectionCaches
    {
        ...
        {
            ((MethodInvokerCache)FastReflectionCaches.MethodInvokerCache).ClearCache();
            ((PropertyAccessorCache)FastReflectionCaches.PropertyAccessorCache).ClearCache();
            ((FieldAccessorCache)FastReflectionCaches.FieldAccessorCache).ClearCache();
            ((ConstructorInvokerCache)FastReflectionCaches.ConstructorInvokerCache).ClearCache();
        }
