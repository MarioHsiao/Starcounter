...
namespace Starcounter.Applications.UsageTrackerApp.API.Installer {
    ...
    internal static class ExceptionCollectionHandler {

        private static Object LOCK = new Object();

        public static void Setup_POST(ushort port) {

            Handle.POST(port, "/api/usage/installer/exceptions", (Request request) => {
                lock (LOCK) {
                    ...
                    try {
                        ...
                        bool bValid = incomingJson.IsDefined("exception");
                        if (bValid == false) {
                        ...
                        Db.Transaction(() => {
                            ...
                            InstallerException item = new InstallerException(installation);
                            ...
                            item.StackTrace = data.stackTrace;
                            item.HelpLink = data.helpLink;
