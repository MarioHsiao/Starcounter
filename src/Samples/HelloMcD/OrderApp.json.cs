...
partial class OrderApp : App<Order> {
    ...
    string[] products = {   "1% Low Fat Milk Jug",
                                "Angus Bacon & Cheese",
                                ...
                                "Caramel Mocha (Large)",
                                "Caramel Mocha (Small)",
                                "CBO Cheddar Bacon Onion Angus Third Pounder",
                                "CBO Cheddar Bacon Onion Crispy Premium Chicken Sandwich",
                                "CBO Cheddar Bacon Onion Grilled Premium Chicken Sandwich",
                                "Cheeseburger",
                                "Cherry Berry Chiller (12 fl oz cup)",
                                "Cherry Berry Chiller (16 fl oz cup)",
                                "Cherry Berry Chiller (22 fl oz cup)",
                                ...
                                "Dr Pepper® (Small)",
                                "Egg McMuffin®",
                                "Egg Nog McCafe Shake (12 fl oz cup) Small",
                                "Egg Nog McCafe Shake (16 fl oz cup) Medium",
                                "Egg Nog McCafe Shake (22 fl oz cup) Large",
                                ...
                                "Frozen Strawberry Lemonade (16 fl oz cup)",
                                ...
                                "Holiday Mint McFlurry® (12 fl oz cup)",
                                ...
                                "Iced Coffee with Sugar Free Vanilla Syrup (Large)",
                                "Iced Coffee with Sugar Free Vanilla Syrup (Medium)",
                                ...
                                "Iced Coffee-- Regular (Medium)",
                                "Iced Coffee-- Regular (Small)",
                                "Iced Coffee-- Vanilla (Large)",
                                ...
                                "McCafé Caramel Hot Chocolate with Nonfat Milk (Small)",
                                "McCafé Caramel Hot Chocolate with Nonfat Milk (Large)",
                                "McCafé Caramel Hot Chocolate with Nonfat Milk (Medium)",
                                "McChicken ®",
                                "McDouble",
                                "McFlurry® with M&M'S® Candies (12 fl oz cup)",
                                "McFlurry® with M&M'S® Candies (16 fl oz cup)",
                                "McFlurry® with OREO® Cookies (12 fl oz cup)",
                                "McFlurry® with OREO® Cookies (16 fl oz cup)",
                                "McFlurry® with Reese's Peanut Butter Cup® (12 fl oz cup)",
                                "McFlurry® with Reese's Peanut Butter Cup® (16 fl oz cup)",
                                "McFlurry® with Rolo® (12 fl oz cup)",
                                "McRib ®",
                                "Medium French Fries",
                                ...
                                "Nonfat Hazelnut Cappuccino (Medium)",
                                ...
                                "Snack Size Holiday Mint McFlurry®",
                                "Snack Size McFlurry® with M&M'S® Candies",
                                "Snack Size McFlurry® with OREO® Cookies",
                                "Snack Size McFlurry® with Reese's Peanut Butter Cup®",
                                ...
                                "Spicy Chicken McBites™ Regular Size",
                                "Spicy Chicken McBites™ Shareable Size",
                                "Spicy Chicken McBites™ Snack Size",
                                "Sprite® (Child)",
                                "Sprite® (Large)",
                                "Sprite® (Medium)",
                                "Sprite® (Small)",
                                "Strawberry Banana Smoothie (12 fl oz cup)",
                                "Strawberry Banana Smoothie (16 fl oz cup)",
                                "Strawberry Banana Smoothie (22 fl oz cup)",
                                ...
                                "Wild Berry Smoothie (12 fl oz cup)",
                                "Wild Berry Smoothie (16 fl oz cup)",
                                "Wild Berry Smoothie (22 fl oz cup)"
                            };
    ...
    void Handle(Input.Items.Product._Search search) {
        ...
        var productNames = (from p in this.products where (((string)p).IndexOf(search.Value, StringComparison.OrdinalIgnoreCase) != -1) select p).Take(10);

        //        search.App._Options.Clear();  // Dosent work
        while (search.App._Options.Count > 0) {
            search.App._Options.RemoveAt(0);
        }

        if (productNames != null) {
            foreach (var items in productNames) {
                var opt = search.App._Options.Add();
                opt.Description = items;
            }
        }
