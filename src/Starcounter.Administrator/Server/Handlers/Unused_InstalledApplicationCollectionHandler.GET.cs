...
//                    IList<DeployedConfigFile> apps = PackageManager.GetInstallApps(appsRootFolder);
...
//                    foreach (DeployedConfigFile appConfig in apps) {
...
//        private static void BuildApplicationItem(DeployedConfigFile appConfig, string url, string appsRootFolder, string appImagesSubFolder, out Representations.JSON.InstalledApplication item) {
...
//        /// <param name="appsRootFolder"></param>
//        /// <returns></returns>
//        internal static string BuildAppExecutablePath(DeployedConfigFile appConfig, string appsRootFolder) {
