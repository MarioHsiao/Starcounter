 ...
 * 
 * Date: Wed Dec 18 2013 04:56:56 GMT+0100 (Central European Standard Time)
*/
      ...
      compile: function compile(tElement, tAttrs) {
        ...
        var parseAutocomplete = function (scope, column, uiDatagrid) {
          ...
          column.handsontable = {
            ...
            getValue: function() {
              //this does not work for some reason but it's not a new issue
              var sel = this.getSelected();
              var row = sel[0];
              childScope[lhs] = lastItems[row];
 ...
 *
 * Date: Wed Dec 18 2013 04:49:57 GMT+0100 (Central European Standard Time)
 */
...
WalkontableScrollbars.prototype.registerListeners = function () {
  ...
  setInterval(refreshAll, 100); //only idea I have to reposition scrollbars on CSS change of the container (container was moved using some styles after page was loaded)
};
