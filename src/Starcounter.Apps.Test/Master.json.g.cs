...
public partial class Master {
    ...
    public Json Page { get { return this.Get(Template.Page); } set { this.Set(Template.Page, value); } }
    public String Test { get { return this.Get(Template.Test); } set { this.Set(Template.Test, value); } }
    public class MasterTemplate : TJson {
    ...
    public class MasterMetadata : ObjMetadata {
        public MasterMetadata(Json app, TJson template) : base(app, template) { }
