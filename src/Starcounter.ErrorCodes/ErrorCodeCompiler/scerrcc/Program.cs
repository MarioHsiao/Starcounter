...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        try
        {
            ...
            CommandLine.ParseArgs(args, ref instream, ref csfile, ref orangestdcsfile, ref orangeintcsfile, ref cheaderfile, ref mcfile, ref exceptionAssistantContentFile);
            ...
            if (cheaderfile != null)
            {
                Verbose("Writing C header file...");
                anythingDone = true;
                WriteCHeaderFile(allCodes, cheaderfile);
                cheaderfile.Flush();
                if (cheaderfile != Console.Out)
                {
                    cheaderfile.Close();
                }
                Verbose("C header file written.");
            }
            if (csfile != null)
            {
...
//            writer.WriteLine("{0} (0x{1:X}): {2}%0", ec.Name, ec.CodeWithFacility, ec.Description);
    ...
    private static void WriteCHeaderFile(IEnumerable<ErrorCode> allCodes, TextWriter writer)
    {
        writer.WriteLine("/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *");
        writer.WriteLine(" *");
        writer.WriteLine(" * THIS FILE IS AUTOMATICALLY GENERATED. DO NOT EDIT.");
        ...
        writer.WriteLine(" */");
        writer.WriteLine();
        writer.WriteLine("#ifndef STARCOUNTER_ERRORCODES_SCERRRES_H");
        writer.WriteLine("#define STARCOUNTER_ERRORCODES_SCERRRES_H");
        writer.WriteLine();
        // write messages
        foreach (ErrorCode ec in allCodes)
        {
