...
{
    using Starcounter.Tools.GACHelperInternals;

    [ComVisible(false)]
    public static class AssemblyCache
    {
        /// <summary>
        /// Installs the given assembly in the GAC.
        /// </summary>
        /// <param name="assemblyPath"></param>
        public static void InstallAssembly(String assemblyPath)
        {
            AssemblyCache.InstallAssembly(assemblyPath, null);
        }

        public static void InstallAssembly(String assemblyPath, InstallReference reference)
        {
            AssemblyCache.InstallAssembly(assemblyPath, reference, AssemblyCommitFlags.Default);
        }
        ...
        /// <summary>
        /// Uninstalls the given assembly from the GAC.
        /// </summary>
        /// <remarks>
        /// The <paramref name="assemblyName"/> parameter has to be fully specified name, i.e for
        /// v1.* assemblies, it should be "name, Version=xx, Culture=xx, PublicKeyToken=xx" and for
        /// v2.* and higher assemblies, it should be "name, Version=xx, Culture=xx, PublicKeyToken=xx, 
        /// ProcessorArchitecture=xx". If <paramref name="assemblyName"/> is not fully specified, a 
        /// random matching assembly will be uninstalled.
        /// </remarks>
        ...
        /// <summary>
        /// See <c>UninstallAssembly</c> for comments on the name.
        /// </summary>
        /// <param name="assemblyName"></param>
        /// <returns></returns>
...
namespace Starcounter.Tools.GACHelperInternals
{
