...
{
    public class LiveObjects : BaseComponent
    {
        public const string Identifier = "LiveObjects";

        public override string ComponentIdentifier
        {
            get
            {
                return LiveObjects.Identifier;
            }
        }
        ...
        public LiveObjects(ObservableCollection<BaseComponent> components)
            : base(components)
        {
        }
