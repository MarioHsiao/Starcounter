...
namespace Starcounter.Internal
{
    public class MixedCodeConstants
    {
        ...
        /// </summary>
        public const int SOCKET_DATA_OFFSET_PARAMS_INFO = 616;
        public const int SOCKET_DATA_OFFSET_BLOB = 680;
        public const int CHUNK_OFFSET_SOCKET_FLAGS = 128;
        public const int SOCKET_DATA_OFFSET_NETWORK_PROTO_TYPE = 102;
        ...
        public const int SOCKET_DATA_OFFSET_NUM_CHUNKS = 92;
