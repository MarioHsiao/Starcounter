...
%token <keyword> ABORT_P ACCESS ACTION ADD_P ADMIN AFTER
	...
	INNER_P INOUT INSERT INSTEAD INT_P INTEGER
	...
	LEAST LEFT LEVEL LIKE LIMIT LOCAL LOCALTIMESTAMP
	LOCATION LOCK_P
	...
	OBJECT_P OF OFF OFFSET OFFSETKEY OIDS ON ONLY OPERATOR OPTION OPTIONS OR
	...
	SHOW SIMILAR SIMPLE SMALLINT SOME STABLE STANDALONE_P START STARTS 
	STATEMENT STATISTICS STDIN STDOUT STORAGE STRICT_P STRIP_P SUBSTRING
	SYMMETRIC SYSID SYSTEM_P

	TABLE TABLES TABLESPACE TEMP TEMPLATE TEMPORARY TEXT_P THEN TIME TIMESTAMP
	TO TRAILING TRANSACTION TREAT TRIGGER TRIM TRUE_P
	TRUNCATE TRUSTED TYPE_P TYPEOF
...
unreserved_keyword:
			...
			| LEVEL
			| LOCAL
			| LOCALTIMESTAMP // I AM HERE. SEARCH SHOULD IN ENTIRE PROJECT.
			| LOCATION
			| LOCK_P
			| MAPPING
			| MATCH
