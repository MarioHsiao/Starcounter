...
PG_KEYWORD("current_catalog", CURRENT_CATALOG, UNRESERVED_KEYWORD)
PG_KEYWORD("current_date", CURRENT_DATE, UNRESERVED_KEYWORD)
PG_KEYWORD("current_role", CURRENT_ROLE, UNRESERVED_KEYWORD)
PG_KEYWORD("current_schema", CURRENT_SCHEMA, TYPE_FUNC_NAME_KEYWORD)
PG_KEYWORD("current_time", CURRENT_TIME, UNRESERVED_KEYWORD)
...
PG_KEYWORD("offsetkey", OFFSETKEY, RESERVED_KEYWORD)
...
PG_KEYWORD("session_user", SESSION_USER, UNRESERVED_KEYWORD)
