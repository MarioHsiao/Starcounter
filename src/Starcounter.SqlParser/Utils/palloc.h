...
#define palloc(sz)	MemoryContextAlloc(TopMemoryContext, (sz))

#define palloc0(sz) MemoryContextAllocZero(TopMemoryContext, (sz))
...
#define palloc0fast(sz) \
	( MemSetTest(0, sz) ? \
		MemoryContextAllocZeroAligned(TopMemoryContext, sz) : \
		MemoryContextAllocZero(TopMemoryContext, sz) )
