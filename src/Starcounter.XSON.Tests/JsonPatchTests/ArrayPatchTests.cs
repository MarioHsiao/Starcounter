...
namespace Starcounter.Internal.XSON.Tests {
    ...
    public class ArrayPatchTests : GenerateJsonPatchTests {
        ...
        public static void CreateANewArrayProperty() {
            ...
            jsonPatch.CreateJsonPatch(j, true, false); // Flushing
        ...
        public static void AssignToEnumerable() {
            ...
            Write("JSON-Patch 1", jsonPatch.CreateJsonPatch(company, true, false));
            ...
            Write("JSON-Patch 2", jsonPatch.CreateJsonPatch(company, true, false));

            company.Contacts = new object[] { person, person2 };

            Write("After status 3",company.DebugString);
            Write("JSON-Patch 3", jsonPatch.CreateJsonPatch(company, true, false));

            Write("After status 4 (no changes)", company.DebugString);
            Write("JSON-Patch 4 (empty)", jsonPatch.CreateJsonPatch(company, true, false));
        }
        ...
        public static void AssignArrayPropertyToNewArray() {
            ...
            Session.Current = new Session() { Data = company };
            string patch = jsonPatch.CreateJsonPatch(company, true, false);
            ...
            patch = jsonPatch.CreateJsonPatch(company, true, false);
            Helper.ConsoleWriteLine(patch);
        }
