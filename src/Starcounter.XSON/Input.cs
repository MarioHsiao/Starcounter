...
namespace Starcounter {
    ...
    /// <typeparam name="TTemplate">The type of the ....TODO</typeparam>
    /// <typeparam name="TValue">The type of the value that is being updated</typeparam>
    public class Input<TApp, TTemplate, TValue> : Input<TValue> where TApp : Json<object> where TTemplate : Template {
        ...
        /// <returns>App.</returns>
        public Json<object> FindParent(TContainer parentProperty) {
            return null;
        }
        ...
        /// <returns>``0.</returns>
        public T FindParent<T>() where T : Json<object> {
            return null;
        }
