...
//        public const byte UNDEFINED = 0;
 ...
 //       internal static Change Null = new Change(UNDEFINED, null, null, -1);
        ...
        /// </summary>
        public readonly Json<object> Obj;
        ...
        private Change(byte changeType, Json<object> obj, TValue prop, Int32 index) {
#if DEBUG
        ...
        internal Boolean IsChangeOf(Json<object> obj, TValue template) {
        ...
        /// <returns></returns>
        internal static Change Add(Json<object> obj, TObjArr list, Int32 index) {
        ...
        /// <returns></returns>
        internal static Change Remove(Json<object> obj, TObjArr list, Int32 index) {
        ...
        /// <returns></returns>
        internal static Change Update(Json<object> obj, TValue property) {
        ...
        /// <returns></returns>
        internal static Change Update(Json<object> obj, TValue property, int index) {
