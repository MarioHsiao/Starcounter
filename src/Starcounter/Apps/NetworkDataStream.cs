...
namespace Starcounter
{
    ...
    public unsafe struct NetworkDataStream : INetworkDataStream
    {
        ...
        public void Read(Byte[] buffer, Int32 offset, Int32 length)
        {
            ...
            if (single_chunk_)
            {
                unsafe
                {
                    ...
                    Int32* userDataOffsetPtr = (Int32*)(unmanaged_chunk_ + MixedCodeConstants.CHUNK_OFFSET_USER_DATA);
        ...
        public UInt64 ReadUInt64(Int32 offset)
        {
            ...
            {
                // Reading user data offset.
                Int32* user_data_offset_ptr = (Int32*)(unmanaged_chunk_ + MixedCodeConstants.CHUNK_OFFSET_USER_DATA);
