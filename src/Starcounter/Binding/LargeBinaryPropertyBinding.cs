// ***********************************************************************
// <copyright file="LargeBinaryPropertyBinding.cs" company="Starcounter AB">
...
namespace Starcounter.Binding
{
    ...
    /// <summary>
    /// Class LargeBinaryPropertyBinding
    /// </summary>
    public class LargeBinaryPropertyBinding : PrimitivePropertyBinding
    {
        ...
        /// <exception cref="System.NotSupportedException">Attempt to access a large binary attribute as something other then a large binary attribute.</exception>
