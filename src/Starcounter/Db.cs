...
namespace Starcounter {
    public static partial class Db {
        ...
        /// <param name="action">The action to execute.</param>
        /// <param name="arg1">First parameter to use as input to the action.</param>
        /// <param name="arg2">Second parameter to use as input to the action.</param>
        /// <param name="forceSnapshot">
        /// If set, instructs Starcounter to raise an error if the transaction can't
        /// be executed within a single snapshot (taken at the time of the transaction
        /// start). The default is false, allowing the isolation to drop to "read
        ...
        /// to try until the transaction succeeds. Specify 0 to disable retrying.
        /// </param>
        public static void Transact<T1, T2>(Action<T1, T2> action, T1 arg1, T2 arg2, bool forceSnapshot = false, int maxRetries = 100) {
            int retries = 0;
            uint r;
            ulong handle;
            ulong verify;
        ...
        /// <param name="arg1">First parameter to use as input to the action.</param>
        /// <param name="arg2">Second parameter to use as input to the action.</param>
        /// <param name="arg3">Third parameter to use as input to the action.</param>
        /// <param name="forceSnapshot">
        /// If set, instructs Starcounter to raise an error if the transaction can't
        /// be executed within a single snapshot (taken at the time of the transaction
        /// start). The default is false, allowing the isolation to drop to "read
        ...
        /// to try until the transaction succeeds. Specify 0 to disable retrying.
        /// </param>
        public static void Transact<T1, T2, T3>(Action<T1, T2, T3> action, T1 arg1, T2 arg2, T3 arg3, bool forceSnapshot = false, int maxRetries = 100) {
            int retries = 0;
            uint r;
            ulong handle;
            ulong verify;
        ...
        /// </summary>
        /// <typeparam name="TResult">The type of the return value of the func.</typeparam>
        /// <typeparam name="T1">The type of the first parameter of the func.</typeparam>
        /// <typeparam name="T2">The type of the second parameter of the func.</typeparam>
        /// <param name="func">The func to execute.</param>
        /// <param name="arg1">First parameter to use as input to the func</param>
        /// <param name="arg2">Second parameter to use as input to the func</param>
        /// <param name="forceSnapshot">
        /// If set, instructs Starcounter to raise an error if the transaction can't
        /// be executed within a single snapshot (taken at the time of the transaction
        /// start). The default is false, allowing the isolation to drop to "read
        ...
        /// </param>
        /// <returns>The return value of the func.</returns>
        public static TResult Transact<T1, T2, TResult>(Func<T1, T2, TResult> func, T1 arg1, T2 arg2, bool forceSnapshot = false, int maxRetries = 100) {
            int retries = 0;
            uint r;
            ulong handle;
            ulong verify;
