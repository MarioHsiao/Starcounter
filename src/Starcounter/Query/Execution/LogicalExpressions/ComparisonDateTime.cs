// ***********************************************************************
// <copyright file="ComparisonDateTime.cs" company="Starcounter AB">
...
internal class ComparisonDateTime : CodeGenFilterNode, IComparison
{
    ...
    {
        Nullable<DateTime> value1 = expr1.EvaluateToDateTime(obj);
        Nullable<DateTime> value2 = expr2.EvaluateToDateTime(obj);
        switch (compOperator)
        {
    ...
    public RangePoint CreateRangePoint(Int32 extentNumber, String strPath)
    {
        ...
        {
            return new DateTimeRangePoint(compOperator, expr2);
        }
        ...
        {
            return new DateTimeRangePoint(Optimizer.ReverseOperator(compOperator), expr1);
        }
        return null;
    }
    ...
    {
        stringBuilder.AppendLine(tabs, "ComparisonDateTime(");
    ...
    {
        return CodeAsStringGeneric(compOperator, "ComparisonDatetime", "DATE");
    }

    // Instruction code value.
    protected override UInt32 InstrCode()
    {
        return InstrCodeGeneric(compOperator, CodeGenFilterInstrCodes.UINT_INCR, "ComparisonDatetime");
    }
    ...
    public bool AssertEquals(ILogicalExpression other) {
        ComparisonDateTime otherNode = other as ComparisonDateTime;
        Debug.Assert(otherNode != null);
        return this.AssertEquals(otherNode);
    }
    internal bool AssertEquals(ComparisonDateTime other) {
