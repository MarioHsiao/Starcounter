// ***********************************************************************
// <copyright file="ComparisonDouble.cs" company="Starcounter AB">
...
internal class ComparisonDouble : CodeGenFilterNode, IComparison
{
    ...
    internal ComparisonDouble(ComparisonOperator compOp, ExtentSet extSet, INumericalExpression expr1, INumericalExpression expr2)
    {
    ...
    {
        return new ComparisonDouble(compOperator, outsideJoinExtentSet, expr1.Instantiate(obj), expr2.Instantiate(obj));
    }
    ...
    {
        return new ComparisonDouble(compOperator, outsideJoinExtentSet, expr1.CloneToNumerical(varArray), expr2.CloneToNumerical(varArray));
    }
    ...
    public bool AssertEquals(ILogicalExpression other) {
        ComparisonDouble otherNode = other as ComparisonDouble;
        Debug.Assert(otherNode != null);
        return this.AssertEquals(otherNode);
    }
    internal bool AssertEquals(ComparisonDouble other) {
