...
internal class StringOperation : IStringExpression, IOperation
{
    ...
    internal bool AssertEquals(StringOperation other) {
        ...
        if (other.AssertEqualsVisited)
            return false;
        // Check basic types
        Debug.Assert(this.strOperator == other.strOperator);
        if (this.strOperator != other.strOperator)
            return false;
        ...
        if (this.expr1 == null) {
            ...
            this.expr1.AssertEquals(other.expr1);
        if (areEquals)
            if (this.expr2 == null) {
