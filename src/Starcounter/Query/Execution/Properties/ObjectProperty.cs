...
/// </summary>
internal class ObjectProperty : Property, IObjectPathItem
{
    /// <summary>
    /// Constructor.
    /// </summary>
    ...
    internal ObjectProperty(Int32 extNum, ITypeBinding typeBind, IPropertyBinding propBind)
    {
        if (typeBind == null)
        {
    ...
    public ITypeBinding TypeBinding
    {
        get
        {
            return propBinding.TypeBinding;
        }
    }
    ...
    protected override UInt32 InstrCode()
    {
        ...
        // Returning code as for a property.
        return CodeGenFilterInstrCodes.LDA_REF | ((UInt32) DataIndex << 8);
    }
    ...
    public IObjectView EvaluateToObject(IObjectView obj)
    {
        ...
        if (obj is Row)
        {
            ...
            return partObj.GetObject(propIndex);
        }
        // Control that the type (obj.TypeBinding) of the input object
        // is equal to or a subtype (TypeBinding.SubTypeOf(TypeBinding)) of the type (typeBinding) to which this property belongs
        // is not implemented due to that interfaces cannot be handled and computational cost.
        return obj.GetObject(propIndex);
    }
    ...
    public IObjectExpression Instantiate(Row obj)
    {
        ...
        {
            IObjectView value = EvaluateToObject(obj);
            if (value != null)
            {
                return new ObjectLiteral(value);
            }
            return new ObjectLiteral(propBinding.TypeBinding);
        }
    ...
    {
        stringBuilder.Append(tabs, "ObjectProperty(");
    ...
    {
        stringGen.AppendLine(CodeGenStringGenerator.CODE_SECTION_TYPE.FUNCTIONS, "GetObjectProperty();");
    }
}
}
