...
namespace Starcounter.Query.Execution {
    ...
    internal sealed class FilterKeyBuilder : KeyBuilderBase {
    ...
    internal sealed class IndexKeyBuilder : KeyBuilderBase {
    ...
    internal abstract class KeyBuilderBase {
        protected Byte[] dataBuffer; // Data array.
        protected Int32 position; // The current position in the buffer where data should be appended.

        internal KeyBuilderBase() {
        ...
        protected unsafe static void AppendNonNullValue(Int64 value, Byte[] dataArray) {
            fixed (Byte* buf = dataArray) {
                // First byte is non-zero for defined values.
                *buf = 1;
        ...
        protected unsafe static void AppendNonNullValue(UInt64 value, Byte[] dataArray) {
            fixed (Byte* buf = dataArray) {
                // First byte is non-zero for defined values.
                *buf = 1;
        ...
        protected unsafe static void AppendNonNullValue(Decimal value, Byte[] dataArray) {
            Int64 value2 = X6Decimal.ToEncoded(value);
        ...
        protected static void AppendNonNullValue(Binary value, Byte[] dataArray) {
            // First byte is non-zero for defined values.
            dataArray[0] = 1;
        ...
        protected unsafe static void AppendNonNullValue(Boolean value, Byte[] dataArray) {
            fixed (Byte* buf = dataArray) {
                // First byte is non-zero for defined values.
                *buf = 1;
