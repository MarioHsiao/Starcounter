// ***********************************************************************
// <copyright file="IntegerDynamicRange.cs" company="Starcounter AB">
...
{
internal class IntegerDynamicRange : DynamicRange, IDynamicRange
{
    // Pre-cached range values.
    IntegerRangeValue lower, upper;
    List<NumericalRangePoint> rangePointList;

    internal IntegerDynamicRange()
    {
        rangePointList = new List<NumericalRangePoint>();
        logExpr = null;
        lower = new IntegerRangeValue();
        upper = new IntegerRangeValue();
    }

    private IntegerDynamicRange(List<NumericalRangePoint> rangePointList)
    {
        ...
        ref ComparisonOperator secondOp)
    {
        ...
        IntegerRangeValue rangeValue = null;

        // Going through all range points.
        for (Int32 i = 0; i < rangePointList.Count; i++)
        {
            rangeValue = rangePointList[i].EvaluateToInteger1(contextObj);
    ...
    public IDynamicRange Clone(VariableArray varArray)
    {
        ...
        return new IntegerDynamicRange(rangePointListClone);
    }
