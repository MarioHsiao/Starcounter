...
comparison_types(is,any,any,string):- !.
comparison_types(is,any,numerical,numerical):- !.
comparison_types(is,any,binary,binary):- !.
comparison_types(is,any,boolean,boolean):- !.
comparison_types(is,any,datetime,datetime):- !.
comparison_types(is,any,string,string):- !.
comparison_types(is,any,integer,numerical):- !.
comparison_types(is,any,uinteger,numerical):- !.
comparison_types(is,any,decimal,numerical):- !.
comparison_types(is,any,double,numerical):- !.
comparison_types(is,any,object(Type),object(Type)):- !.
comparison_types(is,numerical,any,numerical):- !.
comparison_types(is,numerical,numerical,numerical):- !.
comparison_types(is,numerical,integer,numerical):- !.
comparison_types(is,numerical,uinteger,numerical):- !.
comparison_types(is,numerical,decimal,numerical):- !.
comparison_types(is,numerical,double,numerical):- !.
comparison_types(is,binary,any,binary):- !.
comparison_types(is,binary,binary,binary):- !.
comparison_types(is,boolean,any,boolean):- !.
comparison_types(is,boolean,boolean,boolean):- !.
comparison_types(is,datetime,any,datetime):- !.
comparison_types(is,datetime,datetime,datetime):- !.
comparison_types(is,string,any,string):- !.
comparison_types(is,string,string,string):- !.
comparison_types(is,integer,any,numerical):- !.
comparison_types(is,integer,numerical,numerical):- !.
comparison_types(is,integer,integer,integer):- !.
comparison_types(is,integer,uinteger,integer):- !.
comparison_types(is,integer,decimal,decimal):- !.
comparison_types(is,integer,double,double):- !.
comparison_types(is,uinteger,any,numerical):- !.
comparison_types(is,uinteger,numerical,numerical):- !.
comparison_types(is,uinteger,integer,integer):- !.
comparison_types(is,uinteger,uinteger,uinteger):- !.
comparison_types(is,uinteger,decimal,decimal):- !.
comparison_types(is,uinteger,double,double):- !.
comparison_types(is,decimal,any,numerical):- !.
comparison_types(is,decimal,numerical,numerical):- !.
comparison_types(is,decimal,integer,decimal):- !.
comparison_types(is,decimal,uinteger,decimal):- !.
comparison_types(is,decimal,decimal,decimal):- !.
comparison_types(is,decimal,double,double):- !.
comparison_types(is,double,any,numerical):- !.
comparison_types(is,double,numerical,numerical):- !.
comparison_types(is,double,integer,double):- !.
comparison_types(is,double,uinteger,double):- !.
comparison_types(is,double,decimal,double):- !.
comparison_types(is,double,double,double):- !.
comparison_types(is,object(Type),any,object(Type)):- !.
comparison_types(is,object(Type),object(Type),object(Type)):- !.
comparison_types(is,object(_),object(_),object(unknown)):- !.

comparison_types(isNot,any,any,string):- !.
comparison_types(isNot,any,numerical,numerical):- !.
comparison_types(isNot,any,binary,binary):- !.
comparison_types(isNot,any,boolean,boolean):- !.
comparison_types(isNot,any,datetime,datetime):- !.
comparison_types(isNot,any,string,string):- !.
comparison_types(isNot,any,integer,numerical):- !.
comparison_types(isNot,any,uinteger,numerical):- !.
comparison_types(isNot,any,decimal,numerical):- !.
comparison_types(isNot,any,double,numerical):- !.
comparison_types(isNot,any,object(Type),object(Type)):- !.
comparison_types(isNot,numerical,any,numerical):- !.
comparison_types(isNot,numerical,numerical,numerical):- !.
comparison_types(isNot,numerical,integer,numerical):- !.
comparison_types(isNot,numerical,uinteger,numerical):- !.
comparison_types(isNot,numerical,decimal,numerical):- !.
comparison_types(isNot,numerical,double,numerical):- !.
comparison_types(isNot,binary,any,binary):- !.
comparison_types(isNot,binary,binary,binary):- !.
comparison_types(isNot,boolean,any,boolean):- !.
comparison_types(isNot,boolean,boolean,boolean):- !.
comparison_types(isNot,datetime,any,datetime):- !.
comparison_types(isNot,datetime,datetime,datetime):- !.
comparison_types(isNot,string,any,string):- !.
comparison_types(isNot,string,string,string):- !.
comparison_types(isNot,integer,any,numerical):- !.
comparison_types(isNot,integer,numerical,numerical):- !.
comparison_types(isNot,integer,integer,integer):- !.
comparison_types(isNot,integer,uinteger,integer):- !.
comparison_types(isNot,integer,decimal,decimal):- !.
comparison_types(isNot,integer,double,double):- !.
comparison_types(isNot,uinteger,any,numerical):- !.
comparison_types(isNot,uinteger,numerical,numerical):- !.
comparison_types(isNot,uinteger,integer,integer):- !.
comparison_types(isNot,uinteger,uinteger,uinteger):- !.
comparison_types(isNot,uinteger,decimal,decimal):- !.
comparison_types(isNot,uinteger,double,double):- !.
comparison_types(isNot,decimal,any,numerical):- !.
comparison_types(isNot,decimal,numerical,numerical):- !.
comparison_types(isNot,decimal,integer,decimal):- !.
comparison_types(isNot,decimal,uinteger,decimal):- !.
comparison_types(isNot,decimal,decimal,decimal):- !.
comparison_types(isNot,decimal,double,double):- !.
comparison_types(isNot,double,any,numerical):- !.
comparison_types(isNot,double,numerical,numerical):- !.
comparison_types(isNot,double,integer,double):- !.
comparison_types(isNot,double,uinteger,double):- !.
comparison_types(isNot,double,decimal,double):- !.
comparison_types(isNot,double,double,double):- !.
comparison_types(isNot,object(Type),any,object(Type)):- !.
comparison_types(isNot,object(Type),object(Type),object(Type)):- !.
comparison_types(isNot,object(_),object(_),object(unknown)):- !.
