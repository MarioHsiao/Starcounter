/**
 * @license AngularJS v1.0.0rc6-b94fb5c8
 ...
 */
var version = {
  full: '1.0.0rc6-b94fb5c8',    // all of these placeholder strings will be replaced by rake's
        ...
        <doc:example>
          <doc:source jsfiddle="false">
            ...
            <div ng-controller="FetchCtrl">
              ...
              <input type="text" ng-model="url" size=""/>
 ...
 *
 */
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', 'model', '$element', // JOCKE
    function($scope, $exceptionHandler, $attr, model, $element) { // JOCKE
...
var ngModelDirective = [function() {
  return {
    inject: {
      model: 'accessor' // JOCKE
    },
    require: ['model', '^?form'], // JOCKE
 ...
 *
 * `ngCloak` works in cooperation with a css rule that is embedded within `angularcs-1.0.js` and
 ...
 *
 * For the best result, `angularcs-1.0.js` script must be loaded in the head section of the html file;
 ...
 * These rules are bundled with angularcs-1.0.js and the rules can be overridden
 ...
 */
var ngRepatteDirective = ngDirective({
  transclude: 'element',
  priority: 1000,
  terminal: true,
  compile: function(element, attr, linker) {
    return function(scope, iterStartElement, attr){
      ...
      if (! match) {
        throw Error("Expected ngRepatte in form of '_item_ in _collection_' but got '" +
          expression + "'.");
      }
      lhs = match[1];
      rhs = match[2];
...
//function Test($scope)
//{
//   $scope.persons = [ {FirstName:"Joachim", LastName:"Wester"}];
//}


//for (var t = 0 ; t < document.childNodes.length ; t++)
//{
//    if (document.childNodes.item(t).setAttribute)
//    {
//        document.childNodes.item(1).setAttribute("ng-app","DefaultApp");
//        document.childNodes.item(1).setAttribute("ng-controller","Test");
//        break;
//    }
//}
