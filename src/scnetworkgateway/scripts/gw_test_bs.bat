...
START CMD /C "timeout 1 && sccode.exe MYDB_SERVER --DatabaseDir=.db --OutputDir=.db.output --TempDir=.db.output --CompilerPath=MinGW\bin\x86_64-w64-mingw32-gcc.exe --AutoStartExePath=NetworkIoTest\NetworkIoTest.exe %6 --SchedulerCount=%2 --ChunksNumber=%5 --UserArguments="DbNumber=0 PortNumber=%4 TestType=%3""
