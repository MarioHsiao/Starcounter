...
CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_HTTP 10000 2000000 100 gateway_simple_http_rps_1worker_10000conns" 1 MODE_GATEWAY_HTTP 81 16384"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_HTTP 100000 2000000 100 gateway_simple_http_rps_1worker_100000conns" 1 MODE_GATEWAY_HTTP 81 262144"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat "2 MODE_GATEWAY_HTTP 100000 2000000 100 gateway_simple_http_rps_2workers_100000conns" 2 MODE_GATEWAY_HTTP 81 262144"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat "3 MODE_GATEWAY_HTTP 100002 2000000 100 gateway_simple_http_rps_3workers_100000conns" 3 MODE_GATEWAY_HTTP 81 262144"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_SMC_HTTP 10000 2000000 100 gateway_with_smc_simple_http_rps_1worker_10000conns" 1 MODE_GATEWAY_SMC_HTTP 81 16384"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
::CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_SMC_HTTP 100000 2000000 100 gateway_with_smc_simple_http_rps_1worker_100000conns" 1 MODE_GATEWAY_SMC_HTTP 81 262144"
::IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
::CMD /C "gw_test_bs.bat "2 MODE_GATEWAY_SMC_HTTP 100000 2000000 100 gateway_with_smc_simple_http_rps_2workers_100000conns" 2 MODE_GATEWAY_SMC_HTTP 81 262144"
::IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
::CMD /C "gw_test_bs.bat "3 MODE_GATEWAY_SMC_HTTP 100002 2000000 100 gateway_with_smc_simple_http_rps_3workers_100000conns" 3 MODE_GATEWAY_SMC_HTTP 81 262144"
::IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED

:: Raw Port Tests

CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_RAW 1000 10000000 100 gateway_simple_raw_eps_1worker_1000conns" 1 MODE_GATEWAY_RAW 81 8192"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_RAW 10000 2000000 100 gateway_simple_raw_eps_1worker_10000conns" 1 MODE_GATEWAY_RAW 81 16384"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_RAW 100000 2000000 100 gateway_simple_raw_eps_1worker_100000conns" 1 MODE_GATEWAY_RAW 81 262144"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED

CMD /C "gw_test_bs.bat "2 MODE_GATEWAY_RAW 1000 20000000 100 gateway_simple_raw_eps_2workers_1000conns" 2 MODE_GATEWAY_RAW 81 8192"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat "2 MODE_GATEWAY_RAW 10000 2000000 100 gateway_simple_raw_eps_2workers_10000conns" 2 MODE_GATEWAY_RAW 81 16384"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat "2 MODE_GATEWAY_RAW 100000 2000000 100 gateway_simple_raw_eps_2workers_100000conns" 2 MODE_GATEWAY_RAW 81 262144"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat "3 MODE_GATEWAY_RAW 10002 2000000 100 gateway_simple_raw_eps_3workers_10000conns" 3 MODE_GATEWAY_RAW 81 16384"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat "3 MODE_GATEWAY_RAW 100002 2000000 100 gateway_simple_raw_eps_3workers_100000conns" 3 MODE_GATEWAY_RAW 81 262144"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_SMC_RAW 10000 2000000 100 gateway_with_smc_simple_raw_eps_1worker_10000conns" 1 MODE_GATEWAY_SMC_RAW 81 16384"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
::CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_SMC_RAW 100000 2000000 100 gateway_with_smc_simple_raw_eps_1worker_100000conns" 1 MODE_GATEWAY_SMC_RAW 81 262144"
::IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
::CMD /C "gw_test_bs.bat "2 MODE_GATEWAY_SMC_RAW 100000 2000000 100 gateway_with_smc_simple_raw_eps_2workers_100000conns" 2 MODE_GATEWAY_SMC_RAW 81 262144"
::IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
::CMD /C "gw_test_bs.bat "3 MODE_GATEWAY_SMC_RAW 100002 2000000 100 gateway_with_smc_simple_raw_eps_3workers_100000conns" 3 MODE_GATEWAY_SMC_RAW 81 262144"
::IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
