...
IF "%SC_RUN_PERFORMANCE_TESTS%"!="True" GOTO :EOF
...
CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_SMC_HTTP 1000 2000000 100 GwSmcSimpleHttpRPS1Worker1000Conn" 1 MODE_GATEWAY_SMC_HTTP 81 8192"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
CMD /C "gw_test_bs.bat "2 MODE_GATEWAY_SMC_HTTP 1000 2000000 100 GwSmcSimpleHttpRPS2Worker1000Conn" 2 MODE_GATEWAY_SMC_HTTP 81 8192"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
CMD /C "gw_test_bs.bat "3 MODE_GATEWAY_SMC_HTTP 1002 2000000 100 GwSmcSimpleHttpRPS3Worker1000Conn" 3 MODE_GATEWAY_SMC_HTTP 81 8192"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_SMC_RAW 1000 2000000 100 GwSmcSimpleRawEchoes1Worker1000Conn" 1 MODE_GATEWAY_SMC_RAW 81 8192"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
CMD /C "gw_test_bs.bat "2 MODE_GATEWAY_SMC_RAW 1000 2000000 100 GwSmcSimpleRawEchoes2Worker1000Conn" 2 MODE_GATEWAY_SMC_RAW 81 8192"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
CMD /C "gw_test_bs.bat "3 MODE_GATEWAY_SMC_RAW 1002 2000000 100 GwSmcSimpleRawEchoes3Worker1000Conn" 3 MODE_GATEWAY_SMC_RAW 81 8192"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
