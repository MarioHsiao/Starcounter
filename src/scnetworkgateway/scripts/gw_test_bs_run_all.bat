...
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat 2 "MODE_GATEWAY_SMC_HTTP 10000 10000000 100 gateway_with_smc_simple_http_rps_2workers_10000conns" 2 MODE_GATEWAY_SMC_HTTP 81 32768"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat 3 "MODE_GATEWAY_SMC_HTTP 10002 10000000 100 gateway_with_smc_simple_http_rps_3workers_10000conns" 3 MODE_GATEWAY_SMC_HTTP 81 32768"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat 2 "MODE_GATEWAY_RAW 100000 10000000 100 gateway_simple_raw_eps_2workers_100000conns" 2 MODE_GATEWAY_RAW 81 262144"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
...
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
CMD /C "gw_test_bs.bat 3 "MODE_GATEWAY_RAW 100002 10000000 100 gateway_simple_raw_eps_3workers_100000conns" 3 MODE_GATEWAY_RAW 81 262144"
IF %ERRORLEVEL% NEQ 0 GOTO TESTFAILED
