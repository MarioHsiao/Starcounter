...
CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_RAW 1000 10000000 100 GwSimpleRawEchoes1Worker1000Conn" 1 MODE_GATEWAY_HTTP 81 8192 --FLAG:NoDb"
CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_RAW 10000 2000000 100 GwSimpleRawEchoes1Worker10000Conn" 1 MODE_GATEWAY_HTTP 81 16384 --FLAG:NoDb"
CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_RAW 100000 2000000 100 GwSimpleRawEchoes1Worker100000Conn" 1 MODE_GATEWAY_HTTP 81 262144 --FLAG:NoDb"

CMD /C "gw_test_bs.bat "2 MODE_GATEWAY_RAW 1000 10000000 100 GwSimpleRawEchoes2Worker1000Conn" 2 MODE_GATEWAY_HTTP 81 8192 --FLAG:NoDb"
CMD /C "gw_test_bs.bat "2 MODE_GATEWAY_RAW 10000 2000000 100 GwSimpleRawEchoes2Worker10000Conn" 2 MODE_GATEWAY_HTTP 81 16384 --FLAG:NoDb"
CMD /C "gw_test_bs.bat "2 MODE_GATEWAY_RAW 100000 2000000 100 GwSimpleRawEchoes2Worker100000Conn" 2 MODE_GATEWAY_HTTP 81 262144 --FLAG:NoDb"

CMD /C "gw_test_bs.bat "3 MODE_GATEWAY_RAW 1002 10000000 100 GwSimpleRawEchoes3Worker1000Conn" 3 MODE_GATEWAY_HTTP 81 8192 --FLAG:NoDb"
CMD /C "gw_test_bs.bat "3 MODE_GATEWAY_RAW 10002 2000000 100 GwSimpleRawEchoes3Worker10000Conn" 3 MODE_GATEWAY_HTTP 81 16384 --FLAG:NoDb"
CMD /C "gw_test_bs.bat "3 MODE_GATEWAY_RAW 100002 2000000 100 GwSimpleRawEchoes3Worker100000Conn" 3 MODE_GATEWAY_HTTP 81 262144 --FLAG:NoDb"

CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_SMC_RAW 1000 10000000 100 GwSmcSimpleRawEchoes1Worker1000Conn" 1 MODE_GATEWAY_HTTP 81 8192 --FLAG:NoDb"
CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_SMC_RAW 10000 2000000 100 GwSmcSimpleRawEchoes1Worker10000Conn" 1 MODE_GATEWAY_HTTP 81 16384 --FLAG:NoDb"
::CMD /C "gw_test_bs.bat "1 MODE_GATEWAY_SMC_RAW 100000 2000000 100 GwSmcSimpleRawEchoes1Worker100000Conn" 1 MODE_GATEWAY_HTTP 81 262144 --FLAG:NoDb"

CMD /C "gw_test_bs.bat "2 MODE_GATEWAY_SMC_RAW 1000 10000000 100 GwSmcSimpleRawEchoes2Worker1000Conn" 2 MODE_GATEWAY_HTTP 81 8192 --FLAG:NoDb"
CMD /C "gw_test_bs.bat "2 MODE_GATEWAY_SMC_RAW 10000 2000000 100 GwSmcSimpleRawEchoes2Worker10000Conn" 2 MODE_GATEWAY_HTTP 81 16384 --FLAG:NoDb"
::CMD /C "gw_test_bs.bat "2 MODE_GATEWAY_SMC_RAW 100000 2000000 100 GwSmcSimpleRawEchoes2Worker100000Conn" 2 MODE_GATEWAY_HTTP 81 262144 --FLAG:NoDb"

CMD /C "gw_test_bs.bat "3 MODE_GATEWAY_SMC_RAW 1002 10000000 100 GwSmcSimpleRawEchoes3Worker1000Conn" 3 MODE_GATEWAY_HTTP 81 8192 --FLAG:NoDb"
CMD /C "gw_test_bs.bat "3 MODE_GATEWAY_SMC_RAW 10002 2000000 100 GwSmcSimpleRawEchoes3Worker10000Conn" 3 MODE_GATEWAY_HTTP 81 16384 --FLAG:NoDb"
::CMD /C "gw_test_bs.bat "3 MODE_GATEWAY_SMC_RAW 100002 2000000 100 GwSmcSimpleRawEchoes3Worker100000Conn" 3 MODE_GATEWAY_HTTP 81 262144 --FLAG:NoDb"
