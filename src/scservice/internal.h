...
extern uint32_t _read_server_config(const wchar_t *server_config_path, wchar_t **pserver_logs_dir, wchar_t **pserver_temp_dir, wchar_t **pserver_database_dir, wchar_t **default_apps_port);
